        ...
        try {
            ...
            if (contents.size() > 0) {
                for (WebElement content : contents) {
                    String name = content.findElement(By.cssSelector("div > div > dl.content_col2_3.cominfo > dt > a")).getText().replace("(주)", "");
                    String address = content.findElement(By.cssSelector("div > div > dl.content_col2_3.cominfo > dd:nth-child(2) > span:nth-child(3)")).getText();
